...
const required = ["index.html", "styles.css", "vite.config.js", path.join("src", "main.jsx"), path.join("src", "App.jsx"), path.join("src", "app", "App.jsx"), path.join("src", "data", "mockData.js"), path.join("src", "routes", "appRoutes.js")];
