...
function PostCoursesPage({ courses, onSaveCourse, onDeleteCourse }) {
  ...
  const submit = (event) => {
    ...
    void onSaveCourse(payload, editingId);
    reset();
  };
